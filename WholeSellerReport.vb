...
Public Class WholeSellerReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gemstone_Management.WholeSellerReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWholeSellerReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WholeSellerReport = New WholeSellerReport
        rpt.Site = Me.Site
        Return rpt
    End Function
