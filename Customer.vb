...
Public Class Customer
    ...
    Private Sub Customer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        adp = New OleDbDataAdapter("select * from Customermaster", cn)
    ...
    Private Sub filldatasetanddataview()
        ds = New DataSet()
        adp.Fill(ds, "Customermaster")
        dv = New DataView(ds.Tables("Customermaster"))
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        ElseIf TextBox7.Text.Count < 10 Or TextBox7.Text.Count > 10 Then
            MsgBox("Invalid Mobile Number !")
        ElseIf Not Regex.Match(TextBox7.Text, "^[0-9]*$", RegexOptions.IgnoreCase).Success Then 'Only number
            MessageBox.Show("Please Enter Numbers Only!") 'Inform User
            TextBox3.Focus() 'Return Focus
            TextBox3.Clear() 'Clear TextBox
        Else
            cmd.CommandText = "select fname,mname,lname,number,address,city,pincode from Customermaster where number='" & str & "'"
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        ...
        ElseIf Not Regex.Match(TextBox1.Text, "^[a-z,A-Z]*$", RegexOptions.IgnoreCase).Success Then 'Only number
            MessageBox.Show("Customer FName must contain Characters Only!") 'Inform User
        ElseIf Not Regex.Match(TextBox8.Text, "^[a-z,A-Z]*$", RegexOptions.IgnoreCase).Success Then 'Only number
            MessageBox.Show("Customer MName must contain Characters Only!") 'Inform User
        ElseIf Not Regex.Match(TextBox2.Text, "^[a-z,A-Z]*$", RegexOptions.IgnoreCase).Success Then 'Only number
            MessageBox.Show("Customer LName must contain Characters Only!") 'Inform User
        ...
        Else
            ...
            ip = cm.Position
            cmd.Connection = cn 'oledbconnctn obj
            cmd.CommandText = "insert into Customermaster values (@fname,@mname,@lname,@number,@address,@city,@pincode)"
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        Else
            ...
            Dim cmd1 As New OleDbCommand("DELETE * FROM Customermaster where number='" & TextBox3.Text & "'", cn)
            cn.Open()
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        Dim cmd As OleDbCommand = New OleDbCommand("delete from Customermaster where fname=@fname,mname=@mname,lname=@lname,number=@number,address=@address,city=@city,pincode=@pincode", cn)
        i = cm.Position
        If (i < 0) Then
