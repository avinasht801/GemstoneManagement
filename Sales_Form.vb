...
Public Class Sales_Form
    ...
    Dim i As Integer
    Dim tax As Integer
    Dim totalwithtax As Integer
    Dim gid, gname, color, cut, carat, price, stk1, wnam
    Private Sub Sales_Form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub temptable()
        ...
        For i = 0 To listlen - 1
            ...
            cmd1.CommandText = "insert into cart values ('" & Label17.Text & "','" & TextBox1.Text & "','" & TextBox4.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & ListBox6.Items.Item(i) & "','" & ListBox1.Items.Item(i) & "','" & ListBox2.Items.Item(i) & "','" & ListBox3.Items.Item(i) & "','" & ListBox4.Items.Item(i) & "','" & ListBox7.Items.Item(i) & "','" & ListBox5.Items.Item(i) & "','" & Label10.Text & "','" & tax & "','" & totalwithtax & "')"
    ...
    Private Sub finaltable()
        ...
        For i = 0 To listlen - 1
            ...
            cmd.CommandText = "insert into SalesHistory values ('" & Label17.Text & "','" & TextBox1.Text & "','" & TextBox4.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & ListBox6.Items.Item(i) & "','" & ListBox1.Items.Item(i) & "','" & ListBox2.Items.Item(i) & "','" & ListBox3.Items.Item(i) & "','" & ListBox4.Items.Item(i) & "','" & ListBox7.Items.Item(i) & "','" & ListBox5.Items.Item(i) & "')"
            cn.Open()
            cmd.ExecuteNonQuery()
            cn.Close()
            filldatasetanddataview()
    ...
    Private Sub updatestock()
        ...
        For i = 0 To listlen - 1
            Dim query As String = "Select * from Gemmaster where Carat='" & ListBox4.Items.Item(i) & "' and Cut='" & ListBox3.Items.Item(i) & "' and Color='" & ListBox2.Items.Item(i) & "' and Gemstone='" & ListBox1.Items.Item(i) & "'"
            cn.Open()
            ...
            cmd = New OleDbCommand()
            cmd.Connection = cn 'oledbconnctn obj
            Dim cmd1 As New OleDbCommand("DELETE * FROM Gemmaster where gem_id='" & ListBox6.Items.Item(i) & "'", cn)
            cn.Open()
            cmd1.ExecuteNonQuery()
            cn.Close()
            cmd.Connection = cn 'oledbconnctn obj
            cmd.CommandText = "insert into Gemmaster values ('" & gid & "','" & gname & "','" & color & "','" & cut & "','" & carat & "','" & price & "','" & updatedstk & "','" & wnam & "')"
    ...
    Private Sub Button6_Click_2(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        Else
            cn.Open()
            cmd.CommandText = "select fname,mname,lname from Customermaster where number='" & TextBox3.Text & "'"
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button9.Click
        Dim submitres As MsgBoxResult
        submitres = MsgBox("Your Current Work Progress will be lost?", MsgBoxStyle.YesNo)
        If submitres = MsgBoxResult.Yes Then
            Me.Controls.Clear()
            InitializeComponent()
            Sales_Form_Load(e, e)
